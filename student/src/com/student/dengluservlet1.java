...
public class dengluservlet1 extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String username=request.getParameter("username1");//获取用户名
		...
		String realcode=(String)session.getAttribute("realcode");
			...
			boolean loginSuc = stuDao.loginCheck2(username,password);
