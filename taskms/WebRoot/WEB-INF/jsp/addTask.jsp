...
#line {
  ...
  <div id="container">
		<div id="header">
			<div style="float: left">任务管理--->添加任务</div>
		...
		<div id="content">
			<form action="task_Add" method="post">
				<table>
					<tr>
					<td>标题</td>
					<td><input name="t.title" id="title"></input><br></td>
				</tr>
				<tr>
					<td>内容</td>
					...
					<tr>
						<td>开始时间</td>
						<td><input name="t.starttime" id="starttime" onfocus="MyCalendar.SetDate(this)" /></td>
					</tr>
					<tr>
						<td>结束时间</td>
						<td><input name="t.endtime" id="endtime" onfocus="MyCalendar.SetDate(this)" /></td>
					</tr>
					<tr>
					<td>创建者</td>
					<td><input readonly="readonly"
						value="${sessionScope.user.name }"> <input
						type="hidden" id="issuer" name="t.issuer"
