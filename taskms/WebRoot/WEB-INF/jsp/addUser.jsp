...
#line {
  ...
  <div id="container">
		<div id="header">
			<div style="float: left">人员管理--->添加账号</div>
		...
		<div id="content">
			<form action="user_Add" method="post">
				<table>
					<tr>
						<td>账号</td>
						<td><input name="u.account" id="uaccount"
							onblur="checkAccount();"></input><br>
						<span id="msg" style="color:red;width:300px;" /></td>
					</tr>
					<tr>
						<td>姓名</td>
						<td><input name="u.name" id="uname"></input></td>
					</tr>
					<tr>
						<td>密码</td>
						<td><input type="password" name="u.pswd" id="upwd"></input>
						<td>
					</tr>

					<tr>
						<td>出生日期</td>
						<td><input name="u.birthday" id="birth" onfocus="MyCalendar.SetDate(this)" /></td>
					</tr>
					<tr>
						<td>入职时间</td>
						<td><input name="u.entry" id="entry" onfocus="MyCalendar.SetDate(this)" /></td>
					</tr>
					<tr>
						<td>直属上级</td>
					...
					<tr>
						<td></td>
						<td><input type="submit" value="添加" onclick="return check();"></input></td>
				</table>
			</form>
